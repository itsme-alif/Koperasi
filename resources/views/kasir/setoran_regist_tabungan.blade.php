    ...
    <div class="content-wrapper p-2">
        ...
        <section class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-5">
                <h1>Setoran Pendaftaran Tabungan</h1>
              </div>
              <div class="col-sm-7">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active">Kasir/Keuangan</li>
                    <li class="breadcrumb-item"><a href="#"> Setoran Pendaftaran Tabungan</a></li>
                </ol>
              </div>
            </div>
          </div><!-- /.container-fluid -->
                            ...
                            <form class="form-horizontal">
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="number" class="form-control" id="tgl_daftar" name="tgl_daftar" placeholder="Masukan ID Tabungan">
                                        </div>
                                        <div class="col-sm-4">
