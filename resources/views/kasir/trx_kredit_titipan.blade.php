    ...
    <div class="content-wrapper p-2">
        ...
        <section class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-5">
                <h1>Transaksi Titipan Harian</h1>
              </div>
              <div class="col-sm-7">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item active">Kasir/Keuangan</li>
                    <li class="breadcrumb-item"><a href="#">Transaksi Titipan Harian</a></li>
                </ol>
              </div>
            </div>
          </div><!-- /.container-fluid -->
                            ...
                            <form class="form-horizontal">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="inputtext3" class="col-sm-4 col-form-label">Penagih (Collector)</label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputtext3" class="col-sm-4 col-form-label">Tanggal Pembayaran</label>
                                        <div class="col-sm-8">
