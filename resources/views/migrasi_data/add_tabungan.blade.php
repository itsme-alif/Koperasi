    ...
    <div class="content-wrapper p-2">
        ...
        <section class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1>PENDAFTARAN REKENING TABUNGAN</h1>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Migrasi Data</a></li>
                  <li class="breadcrumb-item active">PENDAFTARAN REKENING TABUNGAN</li>
                </ol>
              </div>
            </div>
          </div><!-- /.container-fluid -->
            ...
            <div class="row">
              <div class="col-12">
                ...
                <div class="card card-gray-dark">
                    ...
                    <h3 class="card-title">PENDAFTARAN REKENING TABUNGAN</h3>
                    </div>
